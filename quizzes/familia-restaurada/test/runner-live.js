...
const P = JSON.parse(fs.readFileSync(__dirname + '/paths-live.json', 'utf8'));
...
(async () => {
  ...
  fs.writeFileSync(__dirname + '/results-prod-live-newsheet.json', JSON.stringify(results, null, 1));
  await browser.close();
})();
